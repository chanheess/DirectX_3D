...
class Player2 : public GameObject, public SingletonBase<Player2>, public CMemeoryPool<Player2>
{
public:
	Player2();
	~Player2();
	...
	bool IsbreakthColing() { return breaker; } //반환용	돌파중 부딫혓나
