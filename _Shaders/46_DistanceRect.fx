...
struct CHullOutput
{
    float Edge[4] : SV_TessFactor;  //각선분을 몇개로 나눌지에 대한 개수
    float Inside[2] : SV_InsideTessFactor;  //무게중심
};
...
CHullOutput CHS(InputPatch<VertexOutput, 4> input)
{
    ...
    float3 center = position.xyz * 0.25f;   //평균    /곱이 더빠르므로 0.25f곱
...
[domain("quad")] //어떤 도형을 자를지
[partitioning("integer")]
[outputtopology("triangle_cw")]  //두르는 방향
