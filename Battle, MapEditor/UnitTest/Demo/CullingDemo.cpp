...
void CullingDemo::Initialize()
{
	...
	gridShader = new Shader(L"27_Mesh.fxo");
	...
	shader = new Shader(L"39_CpuCulling.fxo");
	...
	modelShader = new Shader(L"39_GpuCulling.fxo");
...
void CullingDemo::PreRender()
{
	
}

void CullingDemo::Render()
{
	floor->Render();
	grid->Render();
...
void CullingDemo::PostRender()
{
	
}

void CullingDemo::CreateMeshData()
{
