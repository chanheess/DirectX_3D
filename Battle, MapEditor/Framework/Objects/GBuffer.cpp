	...
	: shader(shader)
{
	...
	pixelRTV = new RenderTarget(this->width, this->height, DXGI_FORMAT_R8G8B8A8_UNORM);
...
{
	RenderTarget* rtvs[6] = { diffuseRTV, specularRTV, emissiveRTV, normalRTV, tangentRTV, pixelRTV };
	RenderTarget::Sets(rtvs, 6, depthStencil);
