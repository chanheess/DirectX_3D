...
public:
	...
	Matrix GetAttachTransform(UINT index, UINT indexOfBone);
...
private:
	...
	struct AttachDesc
	{
		UINT AttachBoneIndex = 35;	//오른손
		//UINT AttachBoneIndex = 20;	//왼손
		float Padding[3];
	} attachDesc;
...
private:
	...
	CS_InputDesc* csInput = NULL;	//모델갯수만큼 들어감
	CS_OutputDesc* csOutput = NULL;

	ConstantBuffer* computeAttachBuffer;	//attach를 넘겨줄 버퍼
