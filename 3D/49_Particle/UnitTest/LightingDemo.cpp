...
void LightingDemo::Initialize()
{
	...
	shader = new Shader(L"31_Lighting.fx");
...
{
	//static Color color(0.15f, 0.15f, 0.15f, 0.0f);
	//static float intensity = 0.3f;

	//ImGui::ColorEdit3("Color", color);
	//ImGui::InputFloat("Intensity", &intensity, 0.1f);
	//color.a = intensity;

	//floor->Emissive(color);
	//stone->Emissive(color);
	//brick->Emissive(color);
	//wall->Emissive(color);
