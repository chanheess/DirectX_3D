#include "stdafx.h"
#include "InstancingColliderDemo.h"

void InstancingColliderDemo::Initialize()
{
...
void InstancingColliderDemo::Destroy()
{

}

void InstancingColliderDemo::Update()
{
	sky->Update();
	...
	for (UINT i = 0; i < 4; i++)
	{
		Matrix attach = kachujin->GetAttachTransform(i, 35);
		colliders[i]->Collider->GetTransform()->World(attach);
		colliders[i]->Collider->Update();
	}
}

void InstancingColliderDemo::Render()
{
	sky->Render();
...
void InstancingColliderDemo::Mesh()
{
	//Create Material
	{
...
void InstancingColliderDemo::Airplane()
{
...
void InstancingColliderDemo::Kachujin()
{
	weapon = new Model();
...
void InstancingColliderDemo::Pass(UINT mesh, UINT model, UINT anim)
{
